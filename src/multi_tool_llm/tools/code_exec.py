...
_SHARED_MPLCONFIGDIR = Path(tempfile.gettempdir()) / "multi_tool_llm_mplconfig"
...
_FIG_DIR = os.environ["MULTI_TOOL_LLM_FIG_DIR"]
...
def code_exec_tool(
    ...
    workdir = Path(tempfile.mkdtemp(prefix="multi_tool_llm_exec_"))
    ...
    env = {
        **os.environ,
        "MULTI_TOOL_LLM_FIG_DIR": str(fig_dir),
        "MPLBACKEND": "Agg",
